...
>();
const webMockAgentChatListeners = new Set<
  (message: DesktopMessage<AgentChatStreamEvent>) => void
>();
const webMockAgentChatTimers = new Map<string, ReturnType<typeof setTimeout>[]>();
...
function emitWebAgentChatEvent(event: AgentChatStreamEvent) {
