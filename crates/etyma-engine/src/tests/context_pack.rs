...
fn context_pack_source_metadata_hashes_available_source_content() {
    ...
    let metadata = build_context_pack_source_metadata(
        ...
        &[SourceRecord {
            ...
            format: etyma_engine_types::SourceFormat::pdf(),
            status: etyma_engine_types::SourceStatus::ingested(),
            page_count: 1,
...
fn context_pack_artifact_metadata_sanitizes_unreadable_artifact_warnings() {
    ...
    fs::write(
        ...
        serde_json::json!({
            "schemaVersion": "etyma.source_pack.v0",
    ...
    let metadata = build_context_pack_artifact_metadata(
        ...
        &[
            SourceRecord {
                ...
                format: etyma_engine_types::SourceFormat::markdown(),
                status: etyma_engine_types::SourceStatus::ingested(),
                page_count: 1,
                description: String::new(),
                user_context: String::new(),
...
fn context_pack_artifact_metadata_reports_unsupported_evidence_index_schema() {
    ...
    fs::write(
        ...
        serde_json::json!({
            "schemaVersion": "etyma.evidence_index.v99",
    ...
    assert!(metadata.warnings.iter().any(|warning| warning.warning_type
        ...
        && warning.message.contains("etyma.evidence_index.v99")));
    assert!(!metadata
        .warnings
        .iter()
...
fn context_pack_artifact_metadata_prefers_source_pack_and_evidence_index() {
    ...
    fs::write(
        artifact_root.join("evidence_index.json"),
        serde_json::json!({
            "schemaVersion": "etyma.evidence_index.v0",
            "workspaceId": DEFAULT_WORKSPACE_ID,
            "sourceId": "src-context",
            "contentHash": "fnv64:indexed-source",
            "providerRoute": "local_demo",
    ...
    assert_eq!(
        ...
        etyma_engine_types::ContextPackParseConfidence::High
    );
    assert_eq!(
...
fn context_pack_artifact_metadata_reads_v1_evidence_type() {
    ...
    fs::write(
        artifact_root.join("evidence_index.json"),
        serde_json::json!({
            "schemaVersion": "etyma.evidence_index.v1",
            "workspaceId": DEFAULT_WORKSPACE_ID,
            "sourceId": "src-table",
            "contentHash": "fnv64:table",
            "providerRoute": "local_demo",
...
fn context_pack_artifact_metadata_propagates_artifact_warnings_once() {
    ...
    let metadata = build_context_pack_artifact_metadata(
        ...
        &[SourceRecord {
            ...
            markdown_path: markdown_path.display().to_string(),
            format: etyma_engine_types::SourceFormat::markdown(),
            status: etyma_engine_types::SourceStatus::partial(),
            page_count: 2,
            description: String::new(),
            user_context: String::new(),
            ingest_instruction: String::new(),
    ...
    assert_eq!(
        warnings[0].severity,
        etyma_engine_types::ContextPackWarningSeverity::Medium
    );
...
fn graph_trail_context_pack_fixture() -> etyma_engine_types::ContextPackV1 {
    etyma_engine_types::ContextPackV1 {
        schema_version: etyma_engine_types::CONTEXT_PACK_V1_SCHEMA_VERSION.into(),
        pack_id: "ctx_test_pack".into(),
        workspace_id: DEFAULT_WORKSPACE_ID.into(),
        query: "agent reuse".into(),
        generated_at: "2026-05-18T09:00:00Z".into(),
        source_set: vec![etyma_engine_types::ContextPackSourceV0 {
            source_id: "src-context".into(),
            original_filename: "source.md".into(),
            content_hash: "fnv64:source".into(),
            page_count: 1,
            ingestion_status: "ingested".into(),
            staleness: etyma_engine_types::ContextPackStaleness::Current,
            provider_route: "local_demo".into(),
            local_only: true,
        }],
        selected_evidence: vec![etyma_engine_types::ContextPackEvidenceV1 {
            ...
            parse_confidence: etyma_engine_types::ContextPackParseConfidence::High,
            selection_reason: "Selected from graph-aware retrieval.".into(),
            content_hash: "fnv64:source".into(),
            evidence_type: etyma_engine_types::EvidenceType::Relationship,
            graph_trail: Some(etyma_engine_types::ContextPackGraphTrailV1 {
                direct: vec![etyma_engine_types::ContextPackGraphRecordV1 {
                    record_type: etyma_engine_types::ContextPackGraphRecordKindV1::Node,
                    id: "node-context".into(),
                    reason: "Evidence directly supports this graph node.".into(),
                }],
                adjacent: vec![],
                follow_up: vec![etyma_engine_types::ContextPackGraphFollowUpV1 {
                    tool: etyma_engine_types::ContextPackGraphFollowUpToolV1::ReadNode,
                    handle_type: etyma_engine_types::ContextPackGraphHandleTypeV1::Node,
                    arguments: etyma_engine_types::ContextPackGraphFollowUpArgumentsV1::ReadNode(
                        etyma_engine_types::ContextPackGraphReadNodeArgumentsV1 {
        ...
        findings: vec![],
        warnings: vec![],
        retrieval_trace: etyma_engine_types::ContextPackRetrievalTraceV1 {
            strategy: "test".into(),
            chunks_considered: 1,
            chunks_selected: 1,
            budget_requested: 4000,
            budget_used: 100,
            evidence_type_trace: etyma_engine_types::ContextPackEvidenceTypeTraceV1::default(),
        },
...
fn context_pack_v1_persistence_writes_latest_and_history_files() {
    ...
    let decoded: etyma_engine_types::ContextPackV1 =
...
fn read_context_pack_rejects_symlink_escape() {
    ...
    let context_pack = etyma_engine_types::ContextPackV0 {
...
fn read_context_pack_rejects_schema_and_requested_pack_id_mismatch() {
    ...
    let workspace_root = temp.path().join(DEFAULT_WORKSPACE_ID);
    fs::create_dir_all(workspace_root.join("context_packs")).expect("context packs dir");
    let mut context_pack = etyma_engine_types::ContextPackV0 {
        schema_version: etyma_engine_types::CONTEXT_PACK_V0_SCHEMA_VERSION.into(),
    ...
    context_pack.schema_version = "etyma.context_pack.future".into();
    fs::write(
    ...
    context_pack.schema_version = etyma_engine_types::CONTEXT_PACK_V0_SCHEMA_VERSION.into();
