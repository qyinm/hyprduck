...
fn brain_health_reports_source_readiness_metadata() {
    ...
    let source = SourceRecord {
        ...
        source_path: "/private/etyma/sources/src-partial/partial.pdf".into(),
        markdown_path: "/private/etyma/artifacts/src-partial/partial.md".into(),
    ...
    let source_pack = SourcePackV0 {
        schema_version: etyma_engine_types::SOURCE_PACK_V0_SCHEMA_VERSION.into(),
        workspace_id: DEFAULT_WORKSPACE_ID.into(),
        source_id: "src-partial".into(),
        ...
        source_path: "/private/etyma/sources/src-partial/partial.pdf".into(),
        markdown_path: "/private/etyma/artifacts/src-partial/partial.md".into(),
        artifact_root: "/private/etyma/artifacts/src-partial".into(),
        ...
        local_only: false,
        pages: vec![
            etyma_engine_types::SourcePackPageV0 {
                page: 1,
                label: "Page 1".into(),
                image_path: None,
        ...
        warnings: vec![etyma_engine_types::SourcePackWarningV0 {
    ...
    let evidence_index = EvidenceIndexV0 {
        schema_version: etyma_engine_types::EVIDENCE_INDEX_V0_SCHEMA_VERSION.into(),
        workspace_id: DEFAULT_WORKSPACE_ID.into(),
        source_id: "src-partial".into(),
...
fn brain_health_rejects_cross_workspace_artifact_metadata() {
    ...
    write_health_test_snapshot(
        ...
        SourceRecord {
            ...
            source_path: "/private/etyma/sources/src-cross/cross.pdf".into(),
            markdown_path: "/private/etyma/artifacts/src-cross/cross.md".into(),
            format: etyma_engine_types::SourceFormat::pdf(),
    ...
    let source_pack = SourcePackV0 {
        ...
        source_path: "/private/etyma/sources/src-cross/cross.pdf".into(),
        markdown_path: "/private/etyma/artifacts/src-cross/cross.md".into(),
        artifact_root: "/private/etyma/artifacts/src-cross".into(),
...
fn brain_health_keeps_unreadable_and_missing_artifacts_distinct() {
    ...
    write_health_test_snapshot(
        ...
        SourceRecord {
            ...
            source_path: "/private/etyma/sources/src-broken/broken.pdf".into(),
            markdown_path: "/private/etyma/artifacts/src-broken/broken.md".into(),
            format: etyma_engine_types::SourceFormat::pdf(),
            status: SourceStatus::ingested(),
            page_count: 1,
            description: String::new(),
...
fn brain_health_accepts_fresh_v1_evidence_index() {
    ...
    write_health_test_snapshot(
        ...
        SourceRecord {
            ...
            source_path: "/private/etyma/sources/src-v1/v1.pdf".into(),
            markdown_path: "/private/etyma/artifacts/src-v1/v1.md".into(),
            format: etyma_engine_types::SourceFormat::pdf(),
            status: SourceStatus::ingested(),
            page_count: 1,
            description: String::new(),
    ...
    let source_pack = SourcePackV0 {
        ...
        source_path: "/private/etyma/sources/src-v1/v1.pdf".into(),
        markdown_path: "/private/etyma/artifacts/src-v1/v1.md".into(),
        artifact_root: "/private/etyma/artifacts/src-v1".into(),
    ...
    let evidence_index = etyma_engine_types::EvidenceIndexV1 {
        schema_version: etyma_engine_types::EVIDENCE_INDEX_V1_SCHEMA_VERSION.into(),
        workspace_id: DEFAULT_WORKSPACE_ID.into(),
        source_id: "src-v1".into(),
        content_hash: "sha256:v1".into(),
        provider_route: "local_demo".into(),
