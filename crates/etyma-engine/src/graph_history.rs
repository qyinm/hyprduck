...
use etyma_engine_types::{
    ...
    GraphSnapshotSourceRecord, ReadGraphHistoryRequest, ReadGraphHistoryResponseData,
    ReadGraphSnapshotRequest, ReadGraphSnapshotResponseData, ReadRecentEventsRequest,
    SourceRecord, SourceStatus,
};
use serde_json::Value;

use crate::adapters::persistence::graph_version_store::{
    read_node_record_versions, read_relation_record_versions, read_wiki_record_versions,
};
use crate::{
...
fn read_graph_canvas_projection(
    ...
    Option<(
        Vec<etyma_engine_types::BrainNodeRecord>,
        Vec<etyma_engine_types::BrainRelationRecord>,
        Vec<etyma_engine_types::WikiPage>,
    )>,
> {
...
mod tests {
    ...
    fn read_graph_history_returns_record_versions_for_graph_and_wiki_records() {
        ...
        assert_eq!(
            ...
            vec!["etyma.sqlite:wiki_revisions"]
        );
