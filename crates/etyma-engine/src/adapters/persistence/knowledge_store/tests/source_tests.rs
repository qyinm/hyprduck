...
fn graph_snapshot_is_persisted_as_current_graphqlite_workspace_graph() {
    ...
    let snapshot = BrainRepoSnapshot {
        ...
        sources: vec![SourceRecord {
            ...
            workspace_id: "workspace-default".into(),
            original_path: "/Users/etyma/private/original-source-a.pdf".into(),
            source_path: "/Users/etyma/private/source-a.pdf".into(),
            markdown_path: "/Users/etyma/private/source-a.md".into(),
        ...
        evidence: vec![
            EvidenceRef {
                ...
                source_path: Some("/Users/etyma/private/source-a.pdf".into()),
                source_id: Some("source-a".into()),
                markdown_path: Some("/Users/etyma/private/source-a.md".into()),
                image_path: Some("/Users/etyma/private/source-a.png".into()),
    ...
    assert!(!context_pack_json.contains("/Users/etyma/private"));
    ...
    assert!(!source_response_json.contains("/Users/etyma/private"));
    ...
    assert!(!page_response_json.contains("/Users/etyma/private"));
    assert_eq!(
    ...
    assert!(!node_response_json.contains("/Users/etyma/private"));
...
fn hybrid_retrieve_sanitizes_punctuation_for_fts_queries() {
    ...
    let snapshot = BrainRepoSnapshot {
        ...
        sources: vec![SourceRecord {
            ...
            workspace_id: "workspace-default".into(),
            original_path: "/Users/etyma/private/source-alpha.pdf".into(),
            source_path: "/Users/etyma/private/source-alpha.pdf".into(),
            markdown_path: "/Users/etyma/private/source-alpha.md".into(),
            format: SourceFormat::pdf(),
            status: SourceStatus::ingested(),
            page_count: 1,
            description: String::new(),
        ...
        evidence: vec![EvidenceRef {
            ...
            source_path: Some("/Users/etyma/private/source-alpha.pdf".into()),
            source_id: Some("source-alpha".into()),
            markdown_path: Some("/Users/etyma/private/source-alpha.md".into()),
            image_path: None,
            provenance: None,
        }],
        memories: Vec::new(),
...
fn graph_read_projections_exclude_invalidated_records() {
    ...
    assert!(graph_results.iter().all(|result| {
        !(matches!(
            result.kind,
            etyma_engine_types::BrainSearchResultKind::Node
                | etyma_engine_types::BrainSearchResultKind::Relation
...
fn assert_graph_checkpoint_metadata(store: &KnowledgeStore, workspace_id: &str) {
    ...
    assert!(row.2.contains("etyma-knowledge-store"));
    ...
    assert_eq!(row.10, "etyma.sqlite:graphqlite");
}
