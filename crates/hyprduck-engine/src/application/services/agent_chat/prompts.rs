...
pub(super) const EVIDENCE_AGENT_PREAMBLE: &str = r#"You are HyprDuck's local document evidence agent.
...
pub(super) const GENERAL_AGENT_PREAMBLE: &str = r#"You are HyprDuck's agent chat assistant.
...
Do not expose local filesystem paths."#;
pub(super) const CONTEXT_QUERY_PLANNER_PREAMBLE: &str = r#"You are HyprDuck's retrieval query planner.
