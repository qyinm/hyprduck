...
pub(crate) fn compile_agent_orchestrated_project(
    ...
    let document_evidence = page_sections
        ...
        .map(|(index, section)| EvidenceRef {
            ...
            provenance: Some(format!(
                "Source evidence prepared from {}. Derived graph nodes, claims, and relations must be proposed by the graph maintenance agent.",
                section.page_label
            )),
        })
        .collect::<Vec<_>>();
    ...
    answer_by_node_id.insert(
        ...
        AnswerResponse {
            ...
            explanation:
                "HyprDuck keeps deterministic ingest limited to source and evidence preparation. Derived knowledge is written through agent proposals."
                    .into(),
            ...
            suggested_actions: vec![SuggestedAction {
                ...
                description: "Review the source markdown evidence before trusting derived graph updates."
                    .into(),
            }],
        },
    );
