...
use etyma_knowledge::{EvidenceRef, SourceRecord, SourceStatus};

use crate::{BrainContextPack, DocumentFormat, IngestStatus, SourceId, WorkspaceId};

pub const CONTEXT_PACK_V0_SCHEMA_VERSION: &str = "etyma.context_pack.v0";
pub const CONTEXT_PACK_V1_SCHEMA_VERSION: &str = "etyma.context_pack.v1";
pub const SOURCE_PACK_V0_SCHEMA_VERSION: &str = "etyma.source_pack.v0";
pub const EVIDENCE_INDEX_V0_SCHEMA_VERSION: &str = "etyma.evidence_index.v0";
pub const EVIDENCE_INDEX_V1_SCHEMA_VERSION: &str = "etyma.evidence_index.v1";
